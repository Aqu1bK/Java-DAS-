...
public class DFS_Depth_First_search {
    ...
    public static void bfs(ArrayList<Edge>[] graph) { // Fixed: Renamed from dfs to bfs since this is actually BFS implementation
    ...
    public static void main(String args[]){
        ...
        createGraph(graph);
        dfs(graph, 0, new boolean[V]);  // Fixed: Added 'new' keyword before boolean[V]
    }
}